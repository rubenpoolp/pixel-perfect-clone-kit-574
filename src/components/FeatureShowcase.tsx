  ...
  return (
    <section className={`w-full max-w-[1504px] ${className}`}>
      ...
      <p className="text-[#1c1c1c] text-lg font-normal leading-none mt-[22px] max-md:max-w-full">
        Ask Jackie anything — get an insight, a visual, and an actionable next step. No more guessing.
      </p>
        ...
        <div className="gap-5 flex max-md:flex-col max-md:items-stretch">
          ...
          <div className="w-[17%] ml-5 max-md:w-full max-md:ml-0 flex items-center justify-center">
            <img
              ...
              className="aspect-[3.76] object-contain w-full max-w-[218px] shrink-0 max-md:mt-10 max-md:rotate-90 max-md:w-12 max-md:aspect-[0.27] sm:w-32 md:w-48 lg:w-56"
